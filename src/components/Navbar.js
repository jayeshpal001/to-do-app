      ...
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8" >
        <div className="flex justify-between h-16 items-center">
          ...
          {/* <div className="hidden md:flex space-x-6 font-semibold">
            <a href="#" className="hover:text-yellow-300 text-blue-100">Home</a>
            <a href="#" className="hover:text-yellow-300 text-blue-100">About</a>
            <a href="#" className="hover:text-yellow-300 text-blue-100">Services</a>
            <a href="#" className="hover:text-yellow-300 text-blue-100">Contact</a>
          </div> */}
